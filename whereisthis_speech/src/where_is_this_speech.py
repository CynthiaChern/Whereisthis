...
class speech_transform(object):
	...
	self.destid = 8 # goal point (0~6)
        ...
        self.hash_id = ['sofa', 'table', 'chair', 'dinning table', 'television', 'bed', 'wardrobe','out of range'] 
    ...
    def generate_description(self): # func.: generate the guiding description from one place to another.
        ...
        self.description = []
        tmp = []
        tmp.append('I will tell you the route from sofa to sofa.')
        ...
        tmp.append('I will tell you the route from dinning table to dinning table.')
