...
class NavTest():
    ...
    def init_position(self):
        ...
        # 桌子1
        self.set_goal("A",Pose(Point(1.09223, 0.700149, 0.000), Quaternion(0.000, 0.000, 0.589653, 0.807656)))
        # 门口
        self.set_goal("B",Pose(Point(-0.477148, 0.692674, 0.000), Quaternion(0.000, 0.000, 0.541621, 0.840623)) )
        # 客厅
        self.set_goal("C",Pose(Point(2.22594, -0.142666, 0.000), Quaternion(0.000, 0.000, -0.201015, 0.979588)) )
        # 桌子2
        self.set_goal("D",Pose(Point(0.17167, -2.56908, 0.000), Quaternion(0.000, 0.000, 0.940019, 0.341123)) )
        return
